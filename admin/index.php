...
if(isset($_POST['login']))
{
	...
	//Validate users detail and set session for login user
    $LoginOutput = $RegistrationObj->LoginUser();

    if($LoginOutput['is_error']==1){
						...
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								<form method="post" name='login_form' id='login_form' action="index.php">
									...
									<button class="btn btn-primary btn-block" name="login"  value="Submit" type="submit">LOGIN</button>
								</form>
							</div>
						</div>
					</div>
